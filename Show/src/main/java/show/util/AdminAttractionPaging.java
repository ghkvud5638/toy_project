...
public class AdminAttractionPaging {
	...
	public AdminAttractionPaging() { }
	
	//총 게시글 수만 입력하는 생성자
	public AdminAttractionPaging(int totalCount) {
	...
	public AdminAttractionPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public AdminAttractionPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AdminAttractionPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	public String toString() {
		return "AdminShowPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
				+ ", totalPage=" + totalPage + ", pageCount=" + pageCount + ", startPage=" + startPage + ", endPage="
				+ endPage + ", startNo=" + startNo + ", endNo=" + endNo + ", searchText=" + searchText + "]";
	}
