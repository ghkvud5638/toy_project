...
public class ShowlistPaging {
	...
	private List<String> showkind; //공연구분
	private List<String> showarea; //공연 장소
	private List<String> showgenre;// 장르
	private String search; // 공연명 검색
...
public ShowlistPaging() { }
	
	//총 게시글 수만 입력하는 생성자
	public ShowlistPaging(int totalCount) {
	...
	public ShowlistPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public ShowlistPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public ShowlistPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount==0)	setListCount(8);//화면에 보여질 게시글수 기본값 세팅
	...
	public String toString() {
		return "ShowlistPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
				+ ", totalPage=" + totalPage + ", pageCount=" + pageCount + ", startPage=" + startPage + ", endPage="
				+ endPage + ", startNo=" + startNo + ", endNo=" + endNo + ", showkind=" + showkind + ", showarea="
				+ showarea + ", showgenre=" + showgenre + ", search=" + search + ", year=" + year + ", month=" + month
				+ "]";
	}
	...
	public void setShowkind(List<String> showkind) {
		this.showkind = showkind;
	}

	public List<String> getShowarea() {
		return showarea;
	}

	public void setShowarea(List<String> showarea) {
	...
	public void setShowgenre(List<String> showgenre) {
