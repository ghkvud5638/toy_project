...
public class AdminShowPaging {
	...
	public AdminShowPaging() { }
	
	//총 게시글 수만 입력하는 생성자
	public AdminShowPaging(int totalCount) {
	...
	public AdminShowPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public AdminShowPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AdminShowPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
