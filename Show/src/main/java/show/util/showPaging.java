...
public class showPaging {
	...
	//총 게시글 수만 입력하는 생성자
	public showPaging(int totalCount) {
	...
	public showPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public showPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public showPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	public String toString() {
		return "Paging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount + ", totalPage="
				...
				+ ", startNo=" + startNo + ", endNo=" + endNo + ", search=" + search + ", year=" + year +", month=" + month +"]";
	}
