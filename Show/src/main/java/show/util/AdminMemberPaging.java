...
public class AdminMemberPaging {
	...
	private String search; //검색 옵션 
	private String searchText; //검색어

	public AdminMemberPaging() { }
	
	//총 게시글 수만 입력하는 생성자
	public AdminMemberPaging(int totalCount) {
	...
	public AdminMemberPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public AdminMemberPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AdminMemberPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	public String toString() {
		return "AdminMemberPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount + ", totalPage="
				+ totalPage + ", pageCount=" + pageCount + ", startPage=" + startPage + ", endPage=" + endPage
				+ ", startNo=" + startNo + ", endNo=" + endNo + ", search=" + search + ", searchText=" + searchText
				+ "]";
	}
