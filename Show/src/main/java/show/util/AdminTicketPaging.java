...
public class AdminTicketPaging {
	...
	public AdminTicketPaging() { }
	
	//총 게시글 수만 입력하는 생성자
	public AdminTicketPaging(int totalCount) {
	...
	public AdminTicketPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public AdminTicketPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AdminTicketPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
