...
<div class="paging text-center">
	<ul class="pagination">
		...
		<c:if test="${paging.curPage ne 1 }">
			<li><a href="/show/showlist"> <span>&larr;</span></a></li>
		</c:if>
		...
		<%-- 첫 페이지면 금지 표시 --%>
		<c:if test="${paging.curPage ne 1 }">
			<li><a href="/show/showlist?curPage=${paging.curPage-1 }" aria-label="Previous"> <span>&laquo;</span></a></li>
		</c:if>
...
<%-- 		</c:forEach> --%>
		...
		<%-- 마지막 페이지가 아닐 때 버튼 노출 --%>
		<c:if test="${paging.curPage ne paging.totalPage }">
			<li><a href="/show/showlist?curPage=${paging.totalPage }"> <span>&rarr;</span></a></li>
		</c:if>
